    ...
    return (
        ...
        px-32 py-8 font-semibold uppercase tracking-wide text-dark dark:text-light lg:px-16 md:px-12 sm:px-8 z-10'>
            ...
            <div className='flex w-full justify-between items-center lg:hidden'>
                ...
                >
                    <CustomLink href="/" title="Home" className='mr-4 font-atrament text-[28px] tracking-wide' />
                    <CustomLink href="/about" title="About" className='mx-4 font-atrament text-[28px] tracking-wide' />
                    <CustomLink href="/projects" title="Projects" className='mx-4 font-atrament text-[28px] tracking-wide' />
                    <CustomLink href="/contact" title="Contact" className='ml-4 font-atrament text-[28px] tracking-wide' />
                </motion.nav>
                <motion.nav
                    ref={ref}
                    initial={{ y: -50 }}
            ...
            <div className='logo absolute left-[50%] top-2 translate-x-[-50%]'>
                <Logo />
            </div>
        </header>
    )
