...
import LiIconTwo from "./LiIconTwo";
...
const Details = ({ position, company, companyLink, time, address, work }) => {
    ...
    return (
        ...
        >
            <div ref={ref}>
                <LiIconTwo reference={ref} />
                <div className="rounded-2xl border-2 border-solid border-dark 
                    bg-customTwo p-8 dark:bg-dark dark:border-customTwo">
...
const ExperienceTwo = () => {
    return (
        <div className="w-full h-full inline-block my-64 px-32 xl:p-24 lg:p-16 md:p-12 sm:p-8 z-0">
            <h2 className="w-full font-bold text-8xl mb-[6rem] text-center md:text-6xl xs:text-4xl md:mb-16">
                Experience
            </h2>
